package com.walmartlabs.ern.hometurftestminiapp;

import com.walmartlabs.ern.container.miniapps.HometurfTestMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = HometurfTestMiniappActivity.class;
